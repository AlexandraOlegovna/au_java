...
public final class FirstPartTasks {
    ...
    // Сгруппировать альбомы по артистам (в качестве значения вместо объекта 'ru.spbau.mit.Artist' использовать его имя)
    ...
    public static Optional<Album> minMaxRating(Stream<Album> albums) {
        return albums
            .min(Comparator.comparingInt(album ->
                album.getTracks()
                    .stream()
    ...
    public static List<Album> sortByAverageRating(Stream<Album> albums) {
        return albums
            .sorted(Comparator.comparingDouble((Album album) ->
                album.getTracks()
                .stream()
                .mapToInt(Track::getRating)
                .average()
